$(document).ready(function() {
	...
	function war(cards1, cards2) {
        if (cards1.number > cards2.number) {
            return "player1";
        }
        if (cards2.number > cards1.number) {
            return "player2";
        }
        else {
            return false;
	...
	function play() {
        var cards1 = cards_player_1[0];
        var cards2 = cards_player_2[0];
		var winner = war(cards1, cards2);
